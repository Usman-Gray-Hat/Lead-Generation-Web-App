...
$("#updateAccountBtn").click(function(){
  ...
  let name = $("#edit_accountName").val();

  let gmail = $("#edit_gmail").val();
  let gmail_password = $("#edit_gmailPassword").val();

  let twitter = $("#edit_twitter").val();
  let twitter_password = $("#edit_twitterPassword").val();

  let instagram = $("#edit_instagram").val();
  let instagram_password = $("#edit_instagramPassword").val();

  let discord = $("#edit_discord").val();
  let discord_password = $("#edit_discordPassword").val();

  let twitch = $("#edit_twitch").val();
  let twitch_password = $("#edit_twitchPassword").val();
    ...
    else
    {
      ...
      else
      {
        $.ajax({
          ...
          data: {id:id, name:name, gmail:gmail, gmail_password:gmail_password, twitter:twitter,
          twitter_password:twitter_password, instagram:instagram, instagram_password:instagram_password,
          discord:discord, discord_password:discord_password, twitch:twitch, twitch_password:twitch_password},
          success: function (response) 
          {
