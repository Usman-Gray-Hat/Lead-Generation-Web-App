...
<body>
    ...
    <section class="header-section">  
        <nav class="navbar navbar-expand-sm bg-info navbar-dark theme-color">
            ...
            <ul class="navbar-nav">
                ...
                <li class="nav-item">
                    <a href="qualifiedLeads.php" class="nav-link active"><i class="fas fa-check-double"></i> Qualified Leads</a>
                </li>
        ...
        <h1 class="text-center text-white jumbo-heading py-5 bg-dark theme-color">ALL QUALIFIED LEADS</h1>
    </section>
    ...
    <div class="container-fluid mt-2">
        <div class="row">
            <div class="col-md-12">
                ...
                <!-- Export button -->
                <button type="button" id="exportqualifiedLeadBtn" title="Export as excel"
                ...
                data-bs-toggle="modal" data-bs-target="#qualifiedLeadDateRangeModal"><i class="far fa-calendar"></i> Date Filter</button>
                <?php endif; ?>
            </div>
        </div>
    </div>
            ...
            <div class="col-md-12">
                <div class="card shadow mb-3">
                    <div class="card-header">
                        <h2 class="text-center main-heading"> QUALIFIED LEAD RECORDS </h2>
                    </div>
                    <div class="card-body">
                        <table class='table table-bordered text-center table-hover table-striped dataTable' style='width:120%;' id='qualifiedLeadsTable'>
                            <thead>
                                <tr>
    ...
    <!-- Date Range Modal -->
    <div class="modal fade" id="qualifiedLeadDateRangeModal" data-bs-backdrop="static" data-bs-keyboard="false" role="dialog">
        <div class="modal-dialog modal-dialog-scrollable modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form method="POST" id="qualifiedLeadDateRangeForm">                       
                        <!-- From -->
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-primary" id="qualifiedLeadDateRangeBtn">Search</button>
    ...
    var from = '';
    var to = '';
    $("#qualifiedLeadDateRangeBtn").click(function(){
        from = $("#from").val();
        to = $("#to").val();
        if(from==="" || to==="")
        {
        ...
        {
            $("#qualifiedLeadDateRangeModal").modal("hide");
            $("#qualifiedLeadsTable").DataTable().destroy();
            fetchQualifiedLeads();

            // For Table Heading
            $.ajax({
                type: "POST",
                url: "ajax/headings/qualifiedLeads.php",
    ...
    // Export As Excel
    $("#exportqualifiedLeadBtn").click(function(){
        from = $("#from").val();
        to = $("#to").val();
        window.location.href=`Export/qualifiedLeads.php?from=${from}&to=${to}`;
    });    

    // Fetch Lead Generation
    function fetchQualifiedLeads()
    {
        $("#qualifiedLeadsTable").DataTable({
            ...
            "ajax": {
            "type": "POST",
            "url": "ajax/fetch/qualifiedLeads.php",
            "data": {from:from, to:to} 
            },
        "columns": [
            { data: 'lead_timestamp'},
