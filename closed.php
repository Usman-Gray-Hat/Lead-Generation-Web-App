...
<body>
    ...
    <section class="header-section">  
        <nav class="navbar navbar-expand-sm bg-info navbar-dark theme-color">
            ...
            <ul class="navbar-nav">
                ...
                <li class="nav-item">
                    <a href="closed.php" class="nav-link active"><i class="fas fa-check-circle"></i> Closed</a>
                </li>  
        ...
        <h1 class="text-center text-white jumbo-heading py-5 bg-dark theme-color">ALL CLOSED DEALS</h1>
    </section>
    ...
    <div class="container-fluid mt-2">
        <div class="row">
            <div class="col-md-12">
                ...
                <!-- Export As Excel -->
                <button type="button" id="exportClosedBtn" title="Export as excel"
            ...
            <div class="col-md-12">
                <div class="card shadow mb-3">
                    <div class="card-header">
                        <h2 class="text-center main-heading"> CLOSED DEALS INFORMATION </h2>
                    </div>
                    <div class="card-body">
                        <table class='table table-bordered text-center table-hover table-striped dataTable'style='width:100%;' id='closedTable'>
                            <thead>
                                <tr>
                                    <th>CLOSING DATE</th>
                                    <th>EMPLOYEE NAME</th>
        ...
        <div class="modal-dialog modal-dialog-scrollable modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-primary" id="closedDateRangeBtn">Search</button>
    ...
    // Date Range
    $("#closedDateRangeBtn").click(function(){
        from = $("#from").val();
        to = $("#to").val();
        if(from==="" || to==="")
        {
        ...
        // Export As Excel
    $("#exportClosedBtn").click(function(){
        from = $("#from").val();
        to = $("#to").val();
