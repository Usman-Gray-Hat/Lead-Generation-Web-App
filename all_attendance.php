...
<body>
    ...
    <section class="header-section">  
        <nav class="navbar navbar-expand-sm bg-info navbar-dark theme-color">
            ...
            <ul class="navbar-nav">
                ...
                <li class="nav-item">
                    <a href="all_attendance.php" class="nav-link active"><i class="fas fa-clock"></i> Attendance</a>
                </li>
        ...
        <h1 class="text-center text-white jumbo-heading py-5 bg-dark theme-color">ATTENDANCE RECORD</h1>
    </section>
    ...
    <div class="container-fluid mt-2">
        <div class="row">
            <div class="col-md-12">
                ...
                <!-- Export button -->
                <button type="button" id="exportAllAttendanceBtn" title="Export as excel"
            ...
            <div class="col-md-12">
                <div class="card shadow mb-3">
                    <div class="card-header">
                        <h2 class="text-center main-heading"> <?php echo "TOTAL ABSENTS IN THIS MONTH (".strtoupper(date('F-Y')).")"; ?> </h2>
                    </div>
                    <div class="card-body">
                        <table class='table table-bordered text-center table-hover table-striped dataTable' style='width:100%;' id='allAttendanceTable'>
                            <thead>
                                <tr>
        ...
        <div class="modal-dialog modal-dialog-scrollable modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-primary" id="allAttendanceDateRangeBtn">Search</button>
    ...
    var from = '';
    var to = '';
    $("#allAttendanceDateRangeBtn").click(function(){
        from = $("#from").val();
        to = $("#to").val();
        if(from==="" || to==="")
        {
    ...
    // Export As Excel
    $("#exportAllAttendanceBtn").click(function(){
        from = $("#from").val();
        to = $("#to").val();
        ...
        "columns": [
            ...
            { 
                "render": function (data, type, full, meta) {
                    ...
                    buttons += `<a class="btn btn-primary text-white" title="View Complete History"
